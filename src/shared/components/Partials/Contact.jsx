    ...
    <>
      <div id="contact" className="md:px-10 sm:px-10 xl:px-28 "> 
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1  gap-4 pt-11 ">
          ...
          <h2 className='capitalize font-montserrat  text-gray-light tracking-tight leading-10 font-semibold text-justify pb-5 lg:w-3/4 lg:text-[24px]'>Contact Information</h2>
            ...
            <span className="text-gray-light tracking-tight lg:text-[19px] font-roboto font-semibold ml-5">Phone Number</span>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-6 text-gray-light">
              ...
              <div className='flex flex-col items-start pb-2'>
            <span className="text-gray-light tracking-tight lg:text-[19px] font-roboto font-semibold ml-5">Email</span>
            ...
            <div className='flex flex-col items-start pb-2'>
            <span className="text-gray-light tracking-tight lg:text-[19px] font-roboto font-semibold ml-5">Address</span>
             <span className="ml-5  text-gray-light tracking-tight lg:text-[17px]">Zamora St Santo Angel Sur, Santa Cruz Laguna</span>
             </div>
            </div>
          </div>
          <div className="lg:col-span-2 col-span-1">    
          <h2 className='capitalize font-montserrat  text-gray-light tracking-tight leading-10  ml-8 pb-5  text-center lg:w-3/4 lg:text-[24px] font-semibold'>Get In Touch</h2>
          <ContactInfo/>
          </div>
        </div>
      </div>
