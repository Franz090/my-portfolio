    ...
    <>
      <div id="contact" className="md:px-10 sm:px-10 xl:px-28 "> 
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1  gap-4 pt-11 ">
          ...
          <h2 className='capitalize font-montserrat  text-custom-gray tracking-tight leading-10 font-semibold text-justify pt-1 pb-5 lg:w-3/4 lg:text-[24px] md:text-2xl sm:text-2xl text-2xl'>Contact Information</h2>
