...
export default function ContactInfo() {
  ...
  return (
    <form className="lg:w-full " ref={form} onSubmit={sendEmail}>
      {formSubmitted && (
      <div className="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-400 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
      ...
      {success && (
        <div className="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert" id="alert-1">
          <svg className="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
