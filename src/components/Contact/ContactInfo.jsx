    ...
    <form className="lg:w-full" ref={form} onSubmit={sendEmail}>
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full md:w-1/2 px-3">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-first-name" type="text" name="first_name" autoComplete="given-name" />
        </div>
        <div className="w-full md:w-1/2 px-3">
        ...
        <div className="w-full px-3">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-email" type="email" name="user_email" autoComplete="email" />
        </div>
        <div className="w-full px-3">
      ...
      <div className="flex justify-center w-full ">
        <input className="bg-gray-light pt-3 pb-3 hover-bg-gray-dark text-white font-bold rounded w-full" type="submit" value="Send" />
      </div>
    </form>
 )
}
