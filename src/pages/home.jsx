  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:mt-1  md:mt-12">
      ...
      <div className="col-span-1 flex flex-col justify-center items-center relative xl:right-[54px] lg:top-[85px] ">
        ...
        <h1 className="font-montserrat font-semibold xl:text-7xl text-4xl lg:text-left md:text-7xl md:pb-8 sm:pb-2 xl:pb-5 tracking-wider">FRONTEND</h1>
        ...
        <p className='font-montserrat font-normal uppercase text-sm text-gray-light lg:text-left md:text-center xl:mr-52 md:mr-4 relative lg:left-1 md:left-4 md:pt-3 pb-6 md:pb-0 lg:text-1xl lg:leading-6 lg:pt-6  pt-3'> a front-end developer with a passion for web design and a knack for simplifying complex problems, I'm eager to join your team and expand my programming skills.</p>
  </div>
</div>
    </section>
  );
