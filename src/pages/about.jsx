...
const AboutPage = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:flex lg:mt-1 lg:pb-10 pb-2 lg:pt-10 md:pt-3 pt-4 md:px-9  xl:px-44 lg:px-20 space-x-3">
      <div className="col-span-1 lg:flex lg:items-start lg:justify-start lg:w-8/12 flex-col">
        ...
        <p className="text-custom-gray text-[16px] font-light tracking-tight mb-3 subpixel-antialiased">
          Here is my CV. It contains detailed information about my skills, work experience, and projects.
        </p>
        {/* Add the "View CV" button with oblong border radius */}
        <button className="bg-zinc-600 hover:bg-zinc-500 hover:gray-blue-600 text-white font-light py-2 px-4 rounded-full oblong-button text-center subpixel-antialiased">
