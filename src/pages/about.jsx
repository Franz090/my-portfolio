...
const AboutPage = () => {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:flex lg:mt-1  lg:pb-10 pb-2 lg:pt-6 md:pt-3 pt-4 md:px-9  xl:px-36 lg:px-20 space-x-3">
      ...
      <h1  className="lg:text-[27px] md:text-[27px] sm:text-[27px] text-[26px]  mb-2 tracking-wide capitalize font-semibold">
          About Me
        </h1>
        <h2 className="lg:text-2xl md:text-2xl  sm:text-2xl text-2xl font-light tracking-wide mb-4">
